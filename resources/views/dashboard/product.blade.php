...
@if (count($products)>0)
    <table class="table mt-2 ">
        ...
        <tr>
            ...
            <td  class="align-middle"><img src="{{asset($product->photo)}}" width="100%" alt="{{$product->product_name}}"></td>
            <td  class="align-middle "><div class="row"><a class="btn col btn-danger mx-3 " href="{{route('product.delete',['id'=>$product->id])}}"><i class="bi bi-trash"></i></a><a class="btn col btn-success mx-3" href="{{route('product.update',['id'=>$product->id])}}"><i class="bi bi-pencil-square"></i></a></div></td>
        </tr>
        @endforeach
    </tbody>
    </table>
